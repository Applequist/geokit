...
impl<'e> GeodesicSolver<'e> {
    ...
    pub fn solve_direct(&self, p1: (Lon, Lat), alpha1: Azimuth, s12: f64) -> (Lon, Lat, Azimuth) {
        ...
        (
            lon1 + Radians(lambda12),
            Lat::new(Radians(lat2)),
            Azimuth::new(Radians(alpha2)),
        )
    }
    ...
    fn test_solve_direct() {
        ...
        let standard_lines = [
            ...
            Geodesic {
                ...
                lat2: Lat::new(Degrees::dms(26., 7., 42.83946)),
                delta_lon: Degrees::dms(41., 28., 35.50729),
                s: Meters(4_085_966.7026),
                alpha12: Azimuth::new(Degrees::dms(95., 27., 59.630888)),
                alpha2: Azimuth::new(Degrees::dms(118., 5., 58.961608)),
            },
            // Line 2
            Geodesic {
                lat1: Lat::new(Degrees::dms(35., 16., 11.24862)),
                lat2: Lat::new(Degrees::dms(67., 22., 14.77638)),
                delta_lon: Degrees::dms(137., 47., 28.31435),
                s: Meters(8_084_823.8383),
                alpha12: Azimuth::new(Degrees::dms(15., 44., 23.748498)),
                alpha2: Azimuth::new(Degrees::dms(144., 55., 39.921473)),
            },
            // Line 3
            Geodesic {
                lat1: Lat::new(Degrees::dms(1., 0., 0.)),
                lat2: Lat::new(Degrees::dms(-0., 59., 53.83076)),
                delta_lon: Degrees::dms(179., 17., 48.02997),
                s: Meters(19_959_999.9998),
                alpha12: Azimuth::new(Degrees::dms(88., 59., 59.998970)),
                alpha2: Azimuth::new(Degrees::dms(91., 0., 6.118357)),
            },
            // Line 4
            Geodesic {
                lat1: Lat::new(Degrees::dms(1., 0., 0.)),
                lat2: Lat::new(Degrees::dms(1., 1., 15.18952)),
                delta_lon: Degrees::dms(179., 46., 17.84244),
                s: Meters(19_780_006.5588),
                alpha12: Azimuth::new(Degrees::dms(4., 59., 59.999953)),
                alpha2: Azimuth::new(Degrees::dms(174., 59., 59.884804)),
            },
            // Line 5
            Geodesic {
                lat1: Lat::new(Degrees::dms(41., 41., 45.88000)),
                lat2: Lat::new(Degrees::dms(41., 41., 46.20000)),
                delta_lon: Degrees::dms(0., 0., 0.56000),
                s: Meters(16.2839751),
                alpha12: Azimuth::new(Degrees::dms(52., 40., 39.390667)),
                alpha2: Azimuth::new(Degrees::dms(52., 40., 39.763168)),
            },
            // Line 6
            Geodesic {
                lat1: Lat::new(Degrees::dms(30., 0., 0.)),
                lat2: Lat::new(Degrees::dms(37., 53., 32.46584)),
                delta_lon: Degrees::dms(116., 19., 16.68843),
                s: Meters(10002499.9999),
                alpha12: Azimuth::new(Degrees::dms(45., 0., 0.000004)),
                alpha2: Azimuth::new(Degrees::dms(129., 8., 12.326010)),
            },
            // Line 7
            Geodesic {
                lat1: Lat::new(Degrees::dms(37., 0., 0.)),
                lat2: Lat::new(Degrees::dms(28., 15., 36.69535)),
        ...
        let antipodal_lines = [
            ...
            Geodesic {
                ...
                lat2: Lat::new(Degrees::dms(-41., 41., 46.20)),
                delta_lon: Degrees::dms(179., 59., 59.99985),
                s: Meters(20004566.7228),
                alpha12: Azimuth::new(Degrees::dms(179., 58., 49.16255)),
                alpha2: Azimuth::new(Degrees::dms(0., 1., 10.8376)),
            },
            // Line B
            Geodesic {
                lat1: Lat::new(Degrees(0.)),
                lat2: Lat::new(Degrees(0.)),
                delta_lon: Degrees(180.),
                s: Meters(19996147.4168),
                alpha12: Azimuth::new(Degrees::dms(29., 59., 59.9999)),
                alpha2: Azimuth::new(Degrees(150.)),
            },
            // Line C
            Geodesic {
                lat1: Lat::new(Degrees(30.)),
                lat2: Lat::new(Degrees(-30.)),
                delta_lon: Degrees(180.),
                s: Meters(19994364.6069),
                alpha12: Azimuth::new(Degrees::dms(39., 24., 51.8058)),
                alpha2: Azimuth::new(Degrees::dms(140., 35., 8.1942)),
            },
            // Line D
            Geodesic {
                lat1: Lat::new(Degrees(60.)),
                lat2: Lat::new(Degrees::dms(-59., 59., 0.)),
                delta_lon: Degrees::dms(179., 58., 53.03674),
                s: Meters(20000433.9629),
                alpha12: Azimuth::new(Degrees::dms(29., 11., 51.0700)),
                alpha2: Azimuth::new(Degrees::dms(150., 49., 6.8680)),
            },
            // Line E
            Geodesic {
                lat1: Lat::new(Degrees(30.)),
                lat2: Lat::new(Degrees::dms(-29., 50., 0.)),
                delta_lon: Degrees::dms(179., 56., 41.64754),
                s: Meters(19983420.1536),
                alpha12: Azimuth::new(Degrees::dms(16., 2., 28.3389)),
                alpha2: Azimuth::new(Degrees::dms(163., 59., 10.3369)),
            },
            // Line F
            Geodesic {
                lat1: Lat::new(Degrees(30.)),
                lat2: Lat::new(Degrees::dms(-29., 55., 0.)),
        ...
        for (ix, g) in antipodal_lines.iter().enumerate() {
            ...
            let (lon, lat, alpha2) = solver.solve_direct((lon1, g.lat1), g.alpha12, g.s.m());
            assert_abs_diff_eq!(lon, lon1 + g.delta_lon, epsilon = 4e-1); // from 2e-9 to 4e-1 because of Line B
            assert_abs_diff_eq!(lat, g.lat2, epsilon = 2e-9);
